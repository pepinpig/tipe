...
% À commenter pour le rendu final
\input{conseils.tex}
...
On utilise même \mintinline{latex}{\textbackslash newpage} pour éviter que le bloc du \texttt{main} soit à cheval sur deux pages.}
